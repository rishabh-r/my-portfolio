...
const PROJECTS = [
  ...
  },
  {
    ...
    name: 'RSICareBridge',
    type: 'Healthcare AI',
    tech: ['OpenAI GPT', 'FHIR R4 API', 'Azure AI Foundry', 'JavaScript'],
    desc: 'AI-powered FHIR R4 clinical assistant for care coordinators — instant access to patient records, labs, medications & care gaps, fully integrated with any EHR platform.',
    features: [
      'Built on Azure AI Foundry: FHIR standard healthcare chatbot easily integrated in any EHR platform',
      'Natural language patient record retrieval (Search, Encounters, Medications, Procedures)',
      'HIPAA-compliant: Bearer token FHIR R4 auth, no patient data stored',
      'GPT-powered lab analysis with normal range flags & discharge summary generation',
    ],
  },
  {
    icon: '🔍',
